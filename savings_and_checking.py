class SavingsAccount:
    ...
    def __init__(self, name, account_number, balance=0.0, mini_bal=0.0, interest_rate=0.02):
        from bankAccount import BankAccount  # Local import to avoid circular dependency
        self.bank_account = BankAccount(name, balance, mini_bal)  # Create a BankAccount instance
